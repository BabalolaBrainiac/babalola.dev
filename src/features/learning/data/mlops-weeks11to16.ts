...
export const mlopsWeek14 = makeOutlineWeek('mlops-week-14', 'week-14', 14, 'Observability and Production ML Monitoring', 'Prometheus, Grafana, OpenTelemetry, drift detection, and SLOs.', 'Week 14 teaches how to make silent ML failures visible.', ['Instrumented FastAPI server', 'Grafana dashboard', 'Drift simulation script']);
