...
export const mlopsWeek6 = makeOutlineWeek('mlops-week-6', 'week-6', 6, 'Distributed Systems Basics', 'CAP theorem, message queues, RPC, and fault tolerance applied to ML infra control planes.', 'Week 6 bridges your backend distributed systems knowledge directly to ML infrastructure design.', ['Distributed trigger system', 'Queue-based pipeline sketch', 'CAP theorem analysis of your feature store']);
export const mlopsWeek7 = makeOutlineWeek('mlops-week-7', 'week-7', 7, 'Distributed Training', 'Data parallelism, gradient synchronization, NCCL, and scaling efficiency measurement.', 'Week 7 teaches you how multi-GPU and distributed training systems work at the systems level.', ['Scaling benchmark', 'Gradient sync analysis', 'Multi-GPU training notes']);
export const mlopsWeek8 = makeOutlineWeek('mlops-week-8', 'week-8', 8, 'Memory and Large-Model Training', 'ZeRO optimization, FSDP, gradient checkpointing, and memory partitioning strategies.', 'Week 8 teaches you how to train larger models than a single GPU can fit in memory.', ['Memory strategy document', 'ZeRO/FSDP comparison notes', 'Memory bottleneck analysis']);
